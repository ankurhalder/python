...
file = open('Basics/data/output.txt', mode='w')  # Open the file in write mode
...
with open('Basics/data/output.txt', mode='w') as file:
    file.write("Hello, World!\n")  # Write a line to the file
...
with open('Basics/data/output.txt', mode='a') as file:
...
with open('Basics/data/binary_output.bin', mode='wb') as binary_file:
...
with open('Basics/data/output1.txt', mode='w') as file1, open('Basics/data/output2.txt', mode='w') as file2:
...
try:
    with open('Basics/protected/output.txt', mode='w') as file:
        file.write("Hello, World!\n")
...
with open('Basics/data/output.csv', mode='w', newline='') as csv_file:
    csv_writer = csv.writer(csv_file)
    csv_writer.writerows(data_to_write)

# Method 10: Using 'x' mode to create a new file (fails if the file already exists)
try:
    with open('Basics/data/new_file.txt', mode='x') as new_file:
...
with open('Basics/data/output.json', mode='w') as json_file:
...
with open('Basics/data/output.txt', mode='r+') as file:
...
with open('Basics/data/new_file.txt', mode='w') as new_file:
    new_file.write("This is a new file.\n")
