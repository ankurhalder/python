...
file = open('Basics/data/test.txt', mode='r')  # Open the file in read mode
...
with open('Basics/data/test.txt', mode='r') as file:
    data = file.readline()  # Read one line from the file
    print(data)  # Print the read data
...
with open('Basics/data/file1.txt', mode='r') as file1, open('Basics/data/file2.txt', mode='r') as file2:
...
with open('Basics/data/binary_file.bin', mode='rb') as binary_file:
...
with open('Basics/data/data.csv', mode='r') as csv_file:
